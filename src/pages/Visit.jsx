...
await axios.post(
  ...
  const handleContinueOnWhatsApp = () => {
    const text = `🌿 *Free Garden Visit Request*%0A%0A👤 *Name:* ${formData.name}%0A📱 *Mobile:* ${formData.mobile}%0A📍 *Area:* ${formData.location}%0A🌳 *Garden Size:* ${gardenSize}%0A📅 *Preferred Date:* ${formData.date}%0A📝 *Notes:* ${formData.notes || 'None'}`;
